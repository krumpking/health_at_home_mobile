...
class CurvedBox extends StatefulWidget {
  ...
  @override
  CurvedBoxState createState() => CurvedBoxState();
}

class CurvedBoxState extends State<CurvedBox> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CurvedBox oldWidget) {
