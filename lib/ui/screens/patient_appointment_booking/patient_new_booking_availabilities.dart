...
class PatientNewBookingAvailabilities extends StatefulWidget {
  ...
  const PatientNewBookingAvailabilities({Key? key, required this.doctorProfile, required this.isEdit}) : super(key: key);

  @override
  _PatientNewBookingAvailabilitiesState createState() => _PatientNewBookingAvailabilitiesState();
}

class _PatientNewBookingAvailabilitiesState extends State<PatientNewBookingAvailabilities> {
  ...
  void getTimes() {
    ...
    _provider.getAvailabilities(widget.doctorProfile.id!, "${_selectedDate.day}-${_selectedDate.month}-${_selectedDate.year}").then((data) {
      if (data != null) {
        setState(() {
          timeHours = data;
        });
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                            prefixIcon: Padding(
                              ...
                              child: SvgPicture.asset('assets/icons/icon_location.svg'),
                            ),
                            fillColor: App.theme.white,
                            filled: true,
                            hintText: App.progressBooking!.address,
                            hintStyle: TextStyle(fontSize: 16, color: App.theme.grey800),
                          ...
                          Row(
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: widget.doctorProfile.profileImg != null ? NetworkImage(widget.doctorProfile.profileImg!) : null,
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      (widget.doctorProfile.title.isNotEmpty ? widget.doctorProfile.title.replaceAll('.', '') + '. ' : '') +
                                          Utilities.convertToTitleCase(widget.doctorProfile.displayName),
                                    ...
                                    Text(
                                      widget.doctorProfile.specialities.isNotEmpty ? widget.doctorProfile.specialities : '',
                                      textAlign: TextAlign.start,
                                      style: TextStyle(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        SimpleStarRating(
                                          ...
                                          nonFilledIcon: Icon(Icons.star_half, color: App.theme.btnDarkSecondary, size: 24),
                                          onRated: (rate) {},
                                          spacing: 4,
                                        ),
                                      ],
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: [
                                        SvgPicture.asset('assets/icons/icon_user.svg', height: 18, color: App.theme.turquoise),
                                        SizedBox(width: 8),
                                        GestureDetector(
                                          onTap: () {
                                            Navigator.push(context, MaterialPageRoute(builder: (context) {
                                              return PatientViewDoctorProfile(doctor: widget.doctorProfile);
                                            }));
                                          },
                                          child: Text(
                                            'VIEW PROFILE',
                          ...
                          GestureDetector(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: (App.theme.grey300)!, style: BorderStyle.solid, width: 0.7),
                              ),
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  SvgPicture.asset('assets/icons/icon_carret_down.svg', width: 18, height: 18),
                                ],
                              ),
                            ),
                            onTap: () {
                              ...
                              : timeHours.length > 0
                                  ? MediaQuery.removePadding(
                                      ...
                                      child: GridView(
                                        ...
                                        children: List.generate(timeHours.length, (index) {
                                          return TimeSelectButton(
                                            title: timeHours[index],
                                            onPressed: (bool selected) {
                                              setState(() {
                                                _selectedTime = selected ? timeHours[index] : '';
                                              });

                                              App.progressBooking!.startTime = _selectedTime;
                                            },
                                          );
                                        }),
                                      ),
          ...
          child: _selectedTime.isNotEmpty
              ? Container(
                  ...
                  child: PrimaryLargeButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) {
                          return (App.progressBooking!.isRebook || widget.isEdit) ? PatientNewBookingVisitSummary() : PatientNewBookingReasonsVisit();
                        }));
                      }))
              : null,
          elevation: 0,
