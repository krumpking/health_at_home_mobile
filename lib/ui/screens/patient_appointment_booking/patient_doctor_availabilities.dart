...
class PatientDoctorAvailabilities extends StatefulWidget {
  final DoctorProfile doctorProfile;

  const PatientDoctorAvailabilities({Key? key, required this.doctorProfile}) : super(key: key);

  @override
  _PatientDoctorAvailabilitiesState createState() => _PatientDoctorAvailabilitiesState();
}

class _PatientDoctorAvailabilitiesState extends State<PatientDoctorAvailabilities> {
