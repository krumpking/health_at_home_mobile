...
class SubscriptionApplication extends StatefulWidget {
  final Dependent dependent;
  const SubscriptionApplication({Key? key, required this.dependent}) : super(key: key);

  @override
  _SubscriptionApplicationState createState() => _SubscriptionApplicationState();
}

class _SubscriptionApplicationState extends State<SubscriptionApplication> {
